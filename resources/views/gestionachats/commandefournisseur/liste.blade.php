                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                       <a href="{{ route('gestionachat/ajouterfournisseur/nouveau') }}">
                                            <span class="badge bg-info"><i class="bi bi-eye"></i></i></span>
                                        </a>

                                        <a href="{{ url('view/detail/') }}">
                                            <span class="badge bg-success"><i class="bi bi-pencil-square"></i></span>
                                        </a>
                                        <a href="{{ url('delete_user/') }}" onclick="return confirm('Etes-vous sûr de la supprimer?')"><span class="badge bg-danger"><i class="bi bi-trash"></i></span></a>
                                    </td>
                                </tr>
                        </tbody>
                    </table>
